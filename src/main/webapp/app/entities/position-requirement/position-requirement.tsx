  ...
  return (
    <div>
      <h2 id="position-requirement-heading" data-cy="PositionRequirementHeading">
        <Translate contentKey="roster10App.positionRequirement.home.title">Position Requirements</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="roster10App.positionRequirement.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="roster10App.positionRequirement.home.createLabel">Create new Position Requirement</Translate>
          </Link>
        </div>
      </h2>
        ...
        {positionRequirementList && positionRequirementList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="roster10App.positionRequirement.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('mandatoty')}>
                  <Translate contentKey="roster10App.positionRequirement.mandatoty">Mandatoty</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="roster10App.positionRequirement.home.notFound">No Position Requirements found</Translate>
            </div>
          )
        )}
      </div>
