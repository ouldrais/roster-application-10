...
export const PositionRequirementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="roster10App.positionRequirement.delete.question">
        <Translate contentKey="roster10App.positionRequirement.delete.question" interpolate={{ id: positionRequirementEntity.id }}>
