  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="roster10App.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="roster10App.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('roster10App.department.key')} id="department-key" name="key" data-cy="key" type="text" />
              <ValidatedField
                label={translate('roster10App.department.team')}
                id="department-team"
                name="team"
                data-cy="team"
                type="text"
