  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="roster10App.shiftTemplate.home.createOrEditLabel" data-cy="ShiftTemplateCreateUpdateHeading">
            <Translate contentKey="roster10App.shiftTemplate.home.createOrEditLabel">Create or edit a ShiftTemplate</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('roster10App.shiftTemplate.key')}
              ...
              />
              <ValidatedField
                label={translate('roster10App.shiftTemplate.shiftStart')}
              ...
              />
              <ValidatedField
                label={translate('roster10App.shiftTemplate.shiftEnd')}
              ...
              />
              <ValidatedField
                label={translate('roster10App.shiftTemplate.type')}
