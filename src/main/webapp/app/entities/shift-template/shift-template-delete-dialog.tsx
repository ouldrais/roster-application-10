...
export const ShiftTemplateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="roster10App.shiftTemplate.delete.question">
        <Translate contentKey="roster10App.shiftTemplate.delete.question" interpolate={{ id: shiftTemplateEntity.id }}>
