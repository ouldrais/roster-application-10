...
export const ResourcePlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="roster10App.resourcePlan.delete.question">
        <Translate contentKey="roster10App.resourcePlan.delete.question" interpolate={{ id: resourcePlanEntity.id }}>
