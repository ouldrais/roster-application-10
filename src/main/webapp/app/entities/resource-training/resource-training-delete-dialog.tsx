...
export const ResourceTrainingDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="roster10App.resourceTraining.delete.question">
        <Translate contentKey="roster10App.resourceTraining.delete.question" interpolate={{ id: resourceTrainingEntity.id }}>
