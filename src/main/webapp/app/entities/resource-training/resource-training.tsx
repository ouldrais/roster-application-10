  ...
  return (
    <div>
      <h2 id="resource-training-heading" data-cy="ResourceTrainingHeading">
        <Translate contentKey="roster10App.resourceTraining.home.title">Resource Trainings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="roster10App.resourceTraining.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/resource-training/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="roster10App.resourceTraining.home.createLabel">Create new Resource Training</Translate>
          </Link>
        </div>
      </h2>
        ...
        {resourceTrainingList && resourceTrainingList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="roster10App.resourceTraining.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="roster10App.resourceTraining.status">Status</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('status')} />
                </th>
                <th className="hand" onClick={sort('level')}>
                  <Translate contentKey="roster10App.resourceTraining.level">Level</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('level')} />
                </th>
                <th className="hand" onClick={sort('trainer')}>
                  <Translate contentKey="roster10App.resourceTraining.trainer">Trainer</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('trainer')} />
                </th>
                <th className="hand" onClick={sort('activeFrom')}>
                  <Translate contentKey="roster10App.resourceTraining.activeFrom">Active From</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('activeFrom')} />
                </th>
                <th className="hand" onClick={sort('activeto')}>
                  <Translate contentKey="roster10App.resourceTraining.activeto">Activeto</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="roster10App.resourceTraining.home.notFound">No Resource Trainings found</Translate>
            </div>
          )
        )}
      </div>
